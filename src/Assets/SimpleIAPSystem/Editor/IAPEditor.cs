...
namespace SIS
{
    ...
    public class IAPEditor : EditorWindow
    {
        ...
        {
            if (focusRequired && (EditorWindow.focusedWindow == null || EditorWindow.focusedWindow != iapEditor)) return;
            if (((System.DateTime.Now - lastSave).TotalSeconds < 1) || IAPPrefab == null) return;
